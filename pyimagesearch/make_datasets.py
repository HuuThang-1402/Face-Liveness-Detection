...
def make_data(args):
    ...
    cls_fake_path = os.path.join(args.dest, 'fake')
    ...
    for video in tqdm(list_video):
        ...
        if cls == 0:
            idx_0 = extract_frame(video, cls_fake_path, idx_0, args.skip)
        else:
            idx_1 = extract_frame(video, cls_real_path, idx_1, args.skip)
